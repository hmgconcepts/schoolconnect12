...
<script>
  ...
  roleAllow(id) {
    ...
    const map = {
      // Safe common pages
      dashboard: allUsers, notifications: allUsers, inbox: staff + ' ' + parent + ' ' + learner, 'verify-certificate': publicPages, 'teacher-overview': admin, 'feature-guide': allUsers, about: publicPages, contact: publicPages, apply: publicPages,
      announcements: allUsers, events: allUsers, school_calendar: allUsers, voting: allUsers, gallery: allUsers, eresources: staff + ' ' + learner, lost_found: allUsers, helpdesk: allUsers,
      ...
      timetable: allUsers, assignments: staff + ' ' + parent + ' ' + learner, digital_library: staff + ' ' + learner,
      lms: staff + ' ' + learner, gamification: staff + ' ' + learner, conduct: staff + ' ' + parent,
  ...
  modulePage(config, moduleId, opts = {}) {
    ...
    const staffOnly = !studentParentAdd.includes(moduleId);
